...
var form_data = __nccwpck_require__(4550);
...
var proxy_from_env = __nccwpck_require__(4909);
...
var follow_redirects = __nccwpck_require__(3854);
...
;// CONCATENATED MODULE: ./axios.js


// ----------------------------------------------------------------------

const axiosClient = lib_axios.create({
  baseURL:
...
/* harmony default export */ const axios_0 = (axiosClient);
...
const { default: axiosClient } = __nccwpck_require__(3301);
